            ...
            <div className="container mx-auto flex flex-col justify-around p-6 text-center md:p-10 lg:flex-row">
                <div className="flex flex-col justify-center lg:text-left">
                    ...
                    <h1 className="py-2 text-3xl font-semibold leading-tight title-font dark:text-white">
                        Discover. Learn. Share Your Hobby with the World.
                    </h1>
                    <p className="text-gray-600 mt-2 max-w-md dark:text-white">
                        Join thousands of hobbyists on HobbyHub — explore new interests, connect with like-minded people, and grow your passion from anywhere.
                    </p>
                </div>
                <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-6 lg:mt-0 lg:justify-end">
                    <button className="inline-flex items-center px-6 py-3 rounded-lg bg-green-600 text-white hover:bg-green-700 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" className="fill-current w-7 h-7" viewBox="0 0 24 24">
                    ...
                    <button className="inline-flex items-center px-6 py-3 rounded-lg bg-green-600 text-white hover:bg-green-700 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" className="fill-current w-7 h-7" viewBox="0 0 50 50">
